...
class Node:
    ...
    def gini_best_score(self, y, possible_splits):
        ...
        for idx in possible_splits:
            ...
            left_pos, left_neg = np.bincount(left_split, minlength=2)
            right_pos, right_neg = np.bincount(right_split, minlength=2)
            ...
            gini_gain = 1 - (left / total * left_gini + right / total * right_gini)
